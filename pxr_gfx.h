...
//
// Read only access to a font's data structure.
//
...
// Draw a text string.
//
void drawText(Vector2i position, const std::string& text, ResourceKey_t fontKey, Color4u color, ScreenID_t screenid);
