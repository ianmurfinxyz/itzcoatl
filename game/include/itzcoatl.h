...
public:
  ...
  static constexpr float    speedBonusCooldown_s   {2.f};
  ...
  static constexpr float gameOverPeriod_s        {3.f};
  ...
  //
  // Speed bonuses are percentage gains earned by eating nuggets in quick succession. This table
